...
exports.taskToggleDone = exports.renderTasks = exports.renderTaskEdit = exports.editTask = exports.deleteTask = exports.createTask = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            task = (0, _Task["default"])(req.body); // Añadir a mongodb
            _context2.next = 4;
            return task.save();
          case 4:
            res.redirect("/");
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            id = req.params.id;
            _context5.next = 3;
            return _Task["default"].findByIdAndRemove(id);
          case 3:
            res.redirect("/");
          case 4:
          case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            id = req.params.id; // await Task.findByIdAndUpdate(id, { done: !req.body.done } );
            _context6.next = 3;
